-- Migration 024: Pending checkout submissions for manual payment approvals
-- Ensures payment_submissions exists so pending checkouts are persisted for admin review.
